...
def atualizar_idiomas(form):
    lista_idiomas = []
    for campo in form:
        if 'idioma_' in campo.name:
            if campo.data:
                lista_idiomas.append(campo.label.text)
...
def editar_perfil():
    ...
    if form.validate_on_submit():
        ...
        form.morada.data = current_user.morada
